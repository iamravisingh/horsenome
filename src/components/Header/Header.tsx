          ...
          <div className={dialogBody}>
            ...
            <div className={dialogColumn}>
              ...
              <div className={actionRow}>
                <Tooltip title={actions.feedbackTooltip} placement="top">
                  <Button
                    component="a"
                    href={siteConfig.feedback.issuesUrl}
                    target="_blank"
                    rel="noreferrer"
                    variant="contained"
                    color="success"
                ...
                <Tooltip title={actions.supportTooltip} placement="top">
                  <Button
                    component="a"
                    href={siteMetadata.feedbackMailto}
                    variant="contained"
